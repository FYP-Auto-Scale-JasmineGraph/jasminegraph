...
class Partitioner {
  ...
  // perPartitionCap is : Number of vertices that can be store in this
  // partition, This is a dynamic shared pointer containing a value depending on
  // the whole graph size and # of partitions
