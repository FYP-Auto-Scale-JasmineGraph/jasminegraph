...
void JasmineGraphIncrementalStore::_split(const std::string &s, char delim,
                                          Out result) {
...
std::vector<std::string> JasmineGraphIncrementalStore::_split(
...
void JasmineGraphIncrementalStore::addToEdgeCuts(int resident, int foreign,
                                                 int partitionId) {
