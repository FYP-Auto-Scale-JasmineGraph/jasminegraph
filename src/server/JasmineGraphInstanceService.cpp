...
std::map<int, std::vector<std::string>>
    JasmineGraphInstanceService::iterationData;
...
void *instanceservicesession(void *dummyPt) {
  instanceservicesessionargs *sessionargs =
      (instanceservicesessionargs *)dummyPt;
  int connFd = sessionargs->connFd;
  std::map<std::string, JasmineGraphHashMapLocalStore> graphDBMapLocalStores =
      sessionargs->graphDBMapLocalStores;
  std::map<std::string, JasmineGraphHashMapCentralStore>
      graphDBMapCentralStores = sessionargs->graphDBMapCentralStores;
  std::map<std::string, JasmineGraphHashMapDuplicateCentralStore>
  ...
  std::map<std::string, JasmineGraphIncrementalLocalStore *>
      incrementalLocalStoreMap = sessionargs->incrementalLocalStore;
  ...
  instance_logger.log(
      "New service session started on thread " + to_string(pthread_self()),
      "info");
  Utils utils;
  collector.init();

  utils.createDirectory(utils.getJasmineGraphProperty(
  ...
  while (!loop) {
    ...
    if (line.compare(JasmineGraphInstanceProtocol::HANDSHAKE) == 0) {
      ...
      instance_logger.log(
          "Received : " + JasmineGraphInstanceProtocol::BATCH_UPLOAD, "info");
      write(connFd, JasmineGraphInstanceProtocol::OK.c_str(),
            JasmineGraphInstanceProtocol::OK.size());
      ...
      instance_logger.log(
          "Sent : " + JasmineGraphInstanceProtocol::SEND_FILE_NAME, "info");
      bzero(data, INSTANCE_DATA_LENGTH + 1);
      read(connFd, data, INSTANCE_DATA_LENGTH);
      ...
      instance_logger.log(
          "Sent : " + JasmineGraphInstanceProtocol::SEND_FILE_LEN, "info");
      bzero(data, INSTANCE_DATA_LENGTH + 1);
      read(connFd, data, INSTANCE_DATA_LENGTH);
      string size = (data);
      ...
      instance_logger.log(
          "Sent : " + JasmineGraphInstanceProtocol::SEND_FILE_CONT, "info");
      string fullFilePath = utils.getJasmineGraphProperty(
                                "org.jasminegraph.server.instance.datafolder") +
                            "/" + fileName;
      int fileSize = atoi(size.c_str());
      while (true) {
        if (utils.fileExists(fullFilePath)) {
          while (utils.getFileSize(fullFilePath) < fileSize) {
            ...
            read(connFd, data, INSTANCE_DATA_LENGTH);
            line = (data);
            if (line.compare(JasmineGraphInstanceProtocol::FILE_RECV_CHK) ==
                0) {
              write(connFd,
                    JasmineGraphInstanceProtocol::FILE_RECV_WAIT.c_str(),
      ...
      if (line.compare(JasmineGraphInstanceProtocol::FILE_RECV_CHK) == 0) {
        instance_logger.log(
            "Received : " + JasmineGraphInstanceProtocol::FILE_RECV_CHK,
            "info");
        write(connFd, JasmineGraphInstanceProtocol::FILE_ACK.c_str(),
              JasmineGraphInstanceProtocol::FILE_ACK.size());
        instance_logger.log("Sent : " + JasmineGraphInstanceProtocol::FILE_ACK,
                            "info");
      }
      ...
      fullFilePath = utils.getJasmineGraphProperty(
                         "org.jasminegraph.server.instance.datafolder") +
                     "/" + rawname;
      ...
      while (!utils.fileExists(fullFilePath)) {
        ...
        if (response.compare(JasmineGraphInstanceProtocol::BATCH_UPLOAD_CHK) ==
            0) {
          instance_logger.log(
              "Received : " + JasmineGraphInstanceProtocol::BATCH_UPLOAD_CHK,
              "info");
          write(connFd, JasmineGraphInstanceProtocol::BATCH_UPLOAD_WAIT.c_str(),
                JasmineGraphInstanceProtocol::BATCH_UPLOAD_WAIT.size());
          instance_logger.log(
              "Sent : " + JasmineGraphInstanceProtocol::BATCH_UPLOAD_WAIT,
              "info");
        }
      }
      bzero(data, INSTANCE_DATA_LENGTH + 1);
      ...
      if (line.compare(JasmineGraphInstanceProtocol::BATCH_UPLOAD_CHK) == 0) {
        ...
        instance_logger.log(
            "Sent : " + JasmineGraphInstanceProtocol::BATCH_UPLOAD_ACK, "info");
      }

    } else if (line.compare(
                   JasmineGraphInstanceProtocol::BATCH_UPLOAD_CENTRAL) == 0) {
      instance_logger.log(
          "Received : " + JasmineGraphInstanceProtocol::BATCH_UPLOAD_CENTRAL,
          "info");
      write(connFd, JasmineGraphInstanceProtocol::OK.c_str(),
            JasmineGraphInstanceProtocol::OK.size());
      instance_logger.log("Sent : " + JasmineGraphInstanceProtocol::OK, "info");
    ...
    } else if (line.compare(JasmineGraphInstanceProtocol::
                                BATCH_UPLOAD_COMPOSITE_CENTRAL) == 0) {
      instance_logger.log(
          "Received : " +
      ...
      if (line.compare(JasmineGraphInstanceProtocol::BATCH_UPLOAD_CHK) == 0) {
        ...
        instance_logger.log(
            "Sent : " + JasmineGraphInstanceProtocol::BATCH_UPLOAD_ACK, "info");
                   ...
                   JasmineGraphInstanceProtocol::UPLOAD_RDF_ATTRIBUTES) == 0) {
      instance_logger.log(
          "Received : " + JasmineGraphInstanceProtocol::UPLOAD_RDF_ATTRIBUTES,
          "info");
      write(connFd, JasmineGraphInstanceProtocol::OK.c_str(),
            JasmineGraphInstanceProtocol::OK.size());
      instance_logger.log("Sent : " + JasmineGraphInstanceProtocol::OK, "info");
      ...
      if (line.compare(JasmineGraphInstanceProtocol::BATCH_UPLOAD_CHK) == 0) {
        ...
        instance_logger.log(
            "Sent : " + JasmineGraphInstanceProtocol::BATCH_UPLOAD_ACK, "info");
                                ...
                                UPLOAD_RDF_ATTRIBUTES_CENTRAL) == 0) {
      instance_logger.log(
          "Received : " +
      ...
      instance_logger.log(
          "Received : " + JasmineGraphInstanceProtocol::DELETE_GRAPH, "info");
      write(connFd, JasmineGraphInstanceProtocol::OK.c_str(),
            JasmineGraphInstanceProtocol::OK.size());
      instance_logger.log("Sent : " + JasmineGraphInstanceProtocol::OK, "info");
      bzero(data, INSTANCE_DATA_LENGTH + 1);
      ...
      instance_logger.log(
          "Sent : " + JasmineGraphInstanceProtocol::SEND_PARTITION_ID, "info");
      bzero(data, INSTANCE_DATA_LENGTH + 1);
      read(connFd, data, INSTANCE_DATA_LENGTH);
      ...
      instance_logger.log("Sent : " + result, "info");
                   ...
                   JasmineGraphInstanceProtocol::DELETE_GRAPH_FRAGMENT) == 0) {
      // Conditional block for deleting all graph fragments when protocol is
      // used
      instance_logger.log(
          "Received : " + JasmineGraphInstanceProtocol::DELETE_GRAPH_FRAGMENT,
          "info");
      write(connFd, JasmineGraphInstanceProtocol::OK.c_str(),
            JasmineGraphInstanceProtocol::OK.size());
      instance_logger.log("Sent : " + JasmineGraphInstanceProtocol::OK, "info");
      ...
      write(connFd, result.c_str(), result.size());
      instance_logger.log("Sent : " + result, "info");
    } else if (line.compare(JasmineGraphInstanceProtocol::DP_CENTRALSTORE) ==
               0) {
      ...
      JasmineGraphInstanceService::duplicateCentralStore(
          serverPort, stoi(graphID), stoi(partitionID), workerSockets,
          "localhost");
    } else if (line.compare(JasmineGraphInstanceProtocol::
                                WORKER_IN_DEGREE_DISTRIBUTION) == 0) {
      instance_logger.log("Received : In degree distribution to aggregator",
                          "info");
      ...
      map<long, long> degreeDistribution = calculateLocalInDegreeDist(
          graphID, partitionID, graphDBMapLocalStores, graphDBMapCentralStores);
      instance_logger.log(
          "In Degree Dist size: " + to_string(degreeDistribution.size()),
          "info");

      string instanceDataFolderLocation = utils.getJasmineGraphProperty(
          "org.jasminegraph.server.instance.datafolder");
      string attributeFilePart =
          instanceDataFolderLocation + "/" + graphID + "_idd_" + partitionID;
      ofstream partfile;
      partfile.open(attributeFilePart, std::fstream::trunc);
      for (map<long, long>::iterator it = degreeDistribution.begin();
           it != degreeDistribution.end(); ++it) {
        partfile << to_string(it->first) << "\t" << to_string(it->second)
                 << endl;
      }
      partfile.close();
    } else if (line.compare(
                   JasmineGraphInstanceProtocol::IN_DEGREE_DISTRIBUTION) == 0) {
      instance_logger.log("Received : in degree distribution from server",
                          "info");
      ...
      map<long, long> degreeDistribution = calculateInDegreeDist(
          graphID, partitionID, serverPort, graphDBMapLocalStores,
          graphDBMapCentralStores, workerSockets);
    } else if (line.compare(JasmineGraphInstanceProtocol::
                                WORKER_OUT_DEGREE_DISTRIBUTION) == 0) {
      instance_logger.log("Received : Out degree distribution to aggregator",
                          "info");
      ...
      map<long, long> degreeDistribution = calculateLocalOutDegreeDist(
          graphID, partitionID, graphDBMapLocalStores, graphDBMapCentralStores);
      instance_logger.log(
          "Degree Dist size: " + to_string(degreeDistribution.size()), "info");

      string instanceDataFolderLocation = utils.getJasmineGraphProperty(
          "org.jasminegraph.server.instance.datafolder");
      string attributeFilePart =
          instanceDataFolderLocation + "/" + graphID + "_odd_" + partitionID;
      ofstream partfile;
      partfile.open(attributeFilePart, std::fstream::trunc);
      for (map<long, long>::iterator it = degreeDistribution.begin();
           it != degreeDistribution.end(); ++it) {
      ...
      partfile.close();
                   ...
                   JasmineGraphInstanceProtocol::OUT_DEGREE_DISTRIBUTION) ==
               0) {
      instance_logger.log("Received : out degree distribution from server",
                          "info");
      ...
      instance_logger.log(
          "Received Graph ID:" + graphID + " Vertex Count: " + graphVertexCount,
          "info");
      ...
      instance_logger.log("Received iteration count: " + iterationsValue,
                          "info");
      ...
      std::map<std::string, JasmineGraphHashMapLocalStore>
          graphDBMapLocalStoresPgrnk;
      if (JasmineGraphInstanceService::isGraphDBExists(graphID, partitionID)) {
        JasmineGraphInstanceService::loadLocalStore(graphID, partitionID,
                                                    graphDBMapLocalStoresPgrnk);
      }

      if (JasmineGraphInstanceService::isInstanceCentralStoreExists(
              graphID, partitionID)) {
        JasmineGraphInstanceService::loadInstanceCentralStore(
            graphID, partitionID, graphDBMapCentralStores);
      }

      graphDB = graphDBMapLocalStoresPgrnk[graphID + "_" + partitionID];
      centralDB =
          graphDBMapCentralStores[graphID + "_centralstore_" + partitionID];

      instance_logger.log("Start : Calculate Local page rank", "info");

      map<long, double> pageRankResults = calculateLocalPageRank(
          graphID, alpha, partitionID, serverPort, TOP_K_PAGE_RANK,
          graphVertexCount, graphDB, centralDB, workerSockets, iterations);

      instance_logger.log(
          "Page rank size: " + to_string(pageRankResults.size()), "info");

      string instanceDataFolderLocation = utils.getJasmineGraphProperty(
          "org.jasminegraph.server.instance.datafolder");
      string attributeFilePart =
          instanceDataFolderLocation + "/" + graphID + "_pgrnk_" + partitionID;
      ofstream partfile;
      partfile.open(attributeFilePart, std::fstream::trunc);
      for (map<long, double>::iterator it = pageRankResults.begin();
           it != pageRankResults.end(); ++it) {
        partfile << to_string(it->first) << "\t" << to_string(it->second)
                 << endl;
      }
      partfile.close();
      ...
      for (vector<string>::iterator workerIt = workerSockets.begin();
        ...
        int result_wr = write(
            sockfd,
            JasmineGraphInstanceProtocol::WORKER_PAGE_RANK_DISTRIBUTION.c_str(),
        ...
        instance_logger.log(
            "Sent : " +
                JasmineGraphInstanceProtocol::WORKER_PAGE_RANK_DISTRIBUTION,
            "info");
        ...
        if (response.compare(JasmineGraphInstanceProtocol::OK) == 0) {
          instance_logger.log("Received : " + JasmineGraphInstanceProtocol::OK,
                              "info");
          ...
          if (response.compare(JasmineGraphInstanceProtocol::OK) == 0) {
            instance_logger.log(
                "Received : " + JasmineGraphInstanceProtocol::OK, "info");
            ...
            instance_logger.log(
                "Sent : Partition ID " + std::to_string(partitionID), "info");
          }
        }
      }
      instance_logger.log("Finish : Calculate Local page rank.", "info");
    } else if (line.compare(JasmineGraphInstanceProtocol::
                                WORKER_PAGE_RANK_DISTRIBUTION) == 0) {
      write(connFd, JasmineGraphInstanceProtocol::OK.c_str(),
            JasmineGraphInstanceProtocol::OK.size());
      instance_logger.log("Sent : " + JasmineGraphInstanceProtocol::OK, "info");
      bzero(data, INSTANCE_DATA_LENGTH + 1);
      ...
      calculateEgoNet(graphID, partitionID, serverPort, graphDB, centralDB,
                      workerList);

    } else if (line.compare(JasmineGraphInstanceProtocol::WORKER_EGO_NET) ==
               0) {
      instance_logger.log("Received : SEND_EGO_NET_TO_AGGREGATOR from instance",
                          "info");
      ...
      map<long, map<long, unordered_set<long>>> egonetMap =
          calculateLocalEgoNet(graphID, partitionID, serverPort, graphDB,
                               centralDB, workerSockets);

      Utils utils;
      string instanceDataFolderLocation = utils.getJasmineGraphProperty(
          "org.jasminegraph.server.instance.datafolder");
      string attributeFilePart =
          instanceDataFolderLocation + "/" + graphID + "_egonet_" + partitionID;
      ofstream partfile;
      partfile.open(attributeFilePart, std::fstream::trunc);
      for (map<long, map<long, unordered_set<long>>>::iterator it =
               egonetMap.begin();
           it != egonetMap.end(); ++it) {
        map<long, unordered_set<long>> egonetInternalMap = it->second;
        for (map<long, unordered_set<long>>::iterator itm =
                 egonetInternalMap.begin();
             itm != egonetInternalMap.end(); ++itm) {
          unordered_set<long> egonetInternalMapEdges = itm->second;
          for (unordered_set<long>::iterator ite =
                   egonetInternalMapEdges.begin();
               ite != egonetInternalMapEdges.end(); ++ite) {
            partfile << to_string(it->first) << "\t" << to_string(itm->first)
                     << "\t" << to_string(*ite) << endl;
          }
        }
      }
      ...
      instance_logger.log(
          "Received : " + JasmineGraphInstanceProtocol::TRIANGLES, "info");
      write(connFd, JasmineGraphInstanceProtocol::OK.c_str(),
            JasmineGraphInstanceProtocol::OK.size());
      instance_logger.log("Sent : " + JasmineGraphInstanceProtocol::OK, "info");
      bzero(data, INSTANCE_DATA_LENGTH + 1);
      ...
      long localCount = countLocalTriangles(
          graphID, partitionId, graphDBMapLocalStores, graphDBMapCentralStores,
      ...
      write(connFd, result.c_str(), result.size());
                                ...
                                SEND_CENTRALSTORE_TO_AGGREGATOR) == 0) {
      instance_logger.log(
          "Received : " +
              JasmineGraphInstanceProtocol::SEND_CENTRALSTORE_TO_AGGREGATOR,
          "info");
      write(connFd, JasmineGraphInstanceProtocol::SEND_FILE_NAME.c_str(),
            JasmineGraphInstanceProtocol::SEND_FILE_NAME.size());
      instance_logger.log(
      ...
      if (line.compare(JasmineGraphInstanceProtocol::BATCH_UPLOAD_CHK) == 0) {
        ...
        instance_logger.log(
            "Sent : " + JasmineGraphInstanceProtocol::BATCH_UPLOAD_ACK, "info");
                                ...
                                SEND_COMPOSITE_CENTRALSTORE_TO_AGGREGATOR) ==
               0) {
      instance_logger.log("Received : " +
      ...
      if (line.compare(JasmineGraphInstanceProtocol::BATCH_UPLOAD_CHK) == 0) {
        ...
        instance_logger.log(
            "Sent : " + JasmineGraphInstanceProtocol::BATCH_UPLOAD_ACK, "info");
                                ...
                                AGGREGATE_CENTRALSTORE_TRIANGLES) == 0) {
      instance_logger.log(
          "Received : " +
      ...
      instance_logger.log("Received Partition ID List : " + partitionIdList,
                          "info");
      ...
      std::string aggregatedTriangles =
          JasmineGraphInstanceService::aggregateCentralStoreTriangles(
      ...
      for (unsigned i = 0; i < aggregatedTriangles.length();
           i += INSTANCE_DATA_LENGTH - 10) {
        std::string chunk =
            aggregatedTriangles.substr(i, INSTANCE_DATA_LENGTH - 10);
      ...
      for (int loopCount = 0; loopCount < chunksVector.size(); loopCount++) {
        if (loopCount == 0) {
          ...
          write(connFd, chunk.c_str(), chunk.size());
                                ...
                                AGGREGATE_COMPOSITE_CENTRALSTORE_TRIANGLES) ==
               0) {
      instance_logger.log("Received : " +
                              JasmineGraphInstanceProtocol::
                                  AGGREGATE_COMPOSITE_CENTRALSTORE_TRIANGLES,
      ...
      instance_logger.log("Received Available Files: " + availableFiles,
                          "info");
      ...
      instance_logger.log("Received Composite File List : " + compositeFileList,
                          "info");
      ...
      std::string aggregatedTriangles =
          JasmineGraphInstanceService::aggregateCompositeCentralStoreTriangles(
      ...
      for (int loopCount = 0; loopCount < chunksVector.size(); loopCount++) {
        if (loopCount == 0) {
          ...
          write(connFd, chunk.c_str(), chunk.size());
                   ...
                   JasmineGraphInstanceProtocol::PERFORMANCE_STATISTICS) == 0) {
      instance_logger.log(
          "Received : " + JasmineGraphInstanceProtocol::PERFORMANCE_STATISTICS,
          "info");
      write(connFd, JasmineGraphInstanceProtocol::OK.c_str(),
            JasmineGraphInstanceProtocol::OK.size());
      instance_logger.log("Sent : " + JasmineGraphInstanceProtocol::OK, "info");
      ...
      isResourceAllocationRequired =
          utils.trim_copy(isResourceAllocationRequired, " \f\n\r\t\v");
    ...
    } else if (line.compare(JasmineGraphInstanceProtocol::INITIATE_FILES) ==
               0) {
      instance_logger.log(
          "Received : " + JasmineGraphInstanceProtocol::INITIATE_FILES, "info");
      write(connFd, JasmineGraphInstanceProtocol::OK.c_str(),
            JasmineGraphInstanceProtocol::OK.size());
      instance_logger.log("Sent : " + JasmineGraphInstanceProtocol::OK, "info");
      ...
      workerThreads[0] =
          std::thread(&JasmineGraphInstanceService::createPartitionFiles,
                      graphID, partitionID, "local");
      workerThreads[1] =
          std::thread(&JasmineGraphInstanceService::createPartitionFiles,
                      graphID, partitionID, "centralstore");

      for (int threadCount = 0; threadCount < 2; threadCount++) {
        workerThreads[threadCount].join();
      }

    } else if (line.compare(JasmineGraphInstanceProtocol::INITIATE_SERVER) ==
               0) {
      instance_logger.log(
          "Received : " + JasmineGraphInstanceProtocol::INITIATE_SERVER,
          "info");
      write(connFd, JasmineGraphInstanceProtocol::OK.c_str(),
            JasmineGraphInstanceProtocol::OK.size());
      instance_logger.log("Sent : " + JasmineGraphInstanceProtocol::OK, "info");
      ...
      std::thread workerThread =
          std::thread(&JasmineGraphInstanceService::initServer, trainData);
      workerThread.join();

    } else if (line.compare(
                   JasmineGraphInstanceProtocol::INITIATE_ORG_SERVER) == 0) {
      instance_logger.log(
          "Received : " + JasmineGraphInstanceProtocol::INITIATE_ORG_SERVER,
          "info");
      write(connFd, JasmineGraphInstanceProtocol::OK.c_str(),
            JasmineGraphInstanceProtocol::OK.size());
      instance_logger.log("Sent : " + JasmineGraphInstanceProtocol::OK, "info");
      ...
      std::thread workerThread =
          std::thread(&JasmineGraphInstanceService::initOrgServer, trainData);
      workerThread.join();

    } else if (line.compare(JasmineGraphInstanceProtocol::INITIATE_AGG) == 0) {
      instance_logger.log(
          "Received : " + JasmineGraphInstanceProtocol::INITIATE_AGG, "info");
      write(connFd, JasmineGraphInstanceProtocol::OK.c_str(),
            JasmineGraphInstanceProtocol::OK.size());
      instance_logger.log("Sent : " + JasmineGraphInstanceProtocol::OK, "info");
      bzero(data, INSTANCE_DATA_LENGTH);
      ...
      std::thread workerThread =
          std::thread(&JasmineGraphInstanceService::initAgg, trainData);
      workerThread.join();

    } else if (line.compare(JasmineGraphInstanceProtocol::INITIATE_CLIENT) ==
               0) {
      instance_logger.log(
          "Received : " + JasmineGraphInstanceProtocol::INITIATE_CLIENT,
          "info");
      write(connFd, JasmineGraphInstanceProtocol::OK.c_str(),
            JasmineGraphInstanceProtocol::OK.size());
      instance_logger.log("Sent : " + JasmineGraphInstanceProtocol::OK, "info");
      ...
      std::thread workerThread =
          std::thread(&JasmineGraphInstanceService::initClient, trainData);
      workerThread.join();

    } else if (line.compare(JasmineGraphInstanceProtocol::MERGE_FILES) == 0) {
      instance_logger.log(
          "Received : " + JasmineGraphInstanceProtocol::MERGE_FILES, "info");
      write(connFd, JasmineGraphInstanceProtocol::OK.c_str(),
            JasmineGraphInstanceProtocol::OK.size());
      instance_logger.log("Sent : " + JasmineGraphInstanceProtocol::OK, "info");
      bzero(data, INSTANCE_DATA_LENGTH);
      ...
      std::thread workerThread =
          std::thread(&JasmineGraphInstanceService::mergeFiles, trainData);
      workerThread.join();

    } else if (line.compare(
                   JasmineGraphInstanceProtocol::START_STAT_COLLECTION) == 0) {
      instance_logger.log(
          "Received : " + JasmineGraphInstanceProtocol::START_STAT_COLLECTION,
          "debug");
      write(connFd, JasmineGraphInstanceProtocol::OK.c_str(),
            JasmineGraphInstanceProtocol::OK.size());
      instance_logger.log("Sent : " + JasmineGraphInstanceProtocol::OK,
                          "debug");
      collectValid = true;
      JasmineGraphInstanceService::startCollectingLoadAverage();
    } else if (line.compare(
                   JasmineGraphInstanceProtocol::REQUEST_COLLECTED_STATS) ==
               0) {
      instance_logger.log(
          "Received : " + JasmineGraphInstanceProtocol::REQUEST_COLLECTED_STATS,
          "info");
      collectValid = false;
      ...
      for (loadVectorIterator = loadAverageVector.begin();
           loadVectorIterator != loadAverageVector.end();
           ++loadVectorIterator) {
      ...
      loadAverageString =
          loadAverageString.substr(1, loadAverageString.length() - 1);

      std::vector<std::string> chunksVector;

      for (unsigned i = 0; i < loadAverageString.length();
           i += INSTANCE_DATA_LENGTH - 10) {
        std::string chunk =
            loadAverageString.substr(i, INSTANCE_DATA_LENGTH - 10);
    ...
    } else if (line.compare(JasmineGraphInstanceProtocol::INITIATE_TRAIN) ==
               0) {
      instance_logger.log(
          "Received : " + JasmineGraphInstanceProtocol::INITIATE_TRAIN, "info");
      write(connFd, JasmineGraphInstanceProtocol::OK.c_str(),
            JasmineGraphInstanceProtocol::OK.size());
      instance_logger.log("Sent : " + JasmineGraphInstanceProtocol::OK, "info");
      bzero(data, INSTANCE_DATA_LENGTH + 1);
      ...
      write(connFd,
            JasmineGraphInstanceProtocol::SEND_PARTITION_ITERATION.c_str(),
            JasmineGraphInstanceProtocol::SEND_PARTITION_ITERATION.size());
      instance_logger.log(
          "Sent : " + JasmineGraphInstanceProtocol::SEND_PARTITION_ITERATION,
          "info");
      ...
      write(connFd, JasmineGraphInstanceProtocol::SEND_PARTITION_COUNT.c_str(),
            JasmineGraphInstanceProtocol::SEND_PARTITION_ITERATION.size());
      instance_logger.log(
          "Sent : " + JasmineGraphInstanceProtocol::SEND_PARTITION_COUNT,
          "info");
      ...
      instance_logger.log("Received partition iteration - " + partIteration,
                          "info");
      JasmineGraphInstanceService::collectExecutionData(partIteration,
                                                        trainData, partCount);
      instance_logger.log("After calling collector ", "info");

    } else if (line.compare(JasmineGraphInstanceProtocol::INITIATE_PREDICT) ==
               0) {
      instance_logger.log(
          "Received : " + JasmineGraphInstanceProtocol::INITIATE_PREDICT,
          "info");
      write(connFd, JasmineGraphInstanceProtocol::OK.c_str(),
            JasmineGraphInstanceProtocol::OK.size());
      instance_logger.log("Sent : " + JasmineGraphInstanceProtocol::OK, "info");
      ...
      instance_logger.log("Received Own Partitions No: " + ownPartitions,
                          "info");
      ...
      instance_logger.log("Sent : " + JasmineGraphInstanceProtocol::SEND_HOSTS,
                          "info");
      ...
      std::map<std::string, JasmineGraphInstanceService::workerPartitions>
          graphPartitionedHosts;
      ...
      for (std::vector<std::string>::iterator it = hosts.begin();
        ...
        if (count != 0) {
          ...
          graphPartitionedHosts.insert(
              pair<string, JasmineGraphInstanceService::workerPartitions>(
      ...
      int fileSize = atoi(size.c_str());
      while (utils.fileExists(fullFilePath) &&
             utils.getFileSize(fullFilePath) < fileSize) {
        bzero(data, INSTANCE_DATA_LENGTH + 1);
        read(connFd, data, INSTANCE_DATA_LENGTH);
        line = (data);
      ...
      if (totalPartitions != 0) {
        JasmineGraphInstanceService::collectTrainedModels(
            sessionargs, graphID, graphPartitionedHosts, totalPartitions);
      }
      ...
      predictargs.push_back(utils.getJasmineGraphProperty(
          "org.jasminegraph.server.instance.trainedmodelfolder"));
      predictargs.push_back(to_string(totalPartitions + stoi(ownPartitions)));
      std::vector<char *> predict_agrs_vector;
      std::transform(predictargs.begin(), predictargs.end(),
                     std::back_inserter(predict_agrs_vector), converter);

      std::string path =
          "cd " + utils.getJasmineGraphProperty("org.jasminegraph.graphsage") +
          " && ";
      ...
      loop = true;
                   ...
                   JasmineGraphInstanceProtocol::INITIATE_MODEL_COLLECTION) ==
               0) {
      instance_logger.log(
          "Received : " +
              JasmineGraphInstanceProtocol::INITIATE_MODEL_COLLECTION,
      ...
      if (line.compare(JasmineGraphInstanceProtocol::SEND_FILE_NAME) == 0) {
        ...
        if (line.compare(JasmineGraphInstanceProtocol::SEND_FILE_LEN) == 0) {
          instance_logger.log(
              "Received : " + JasmineGraphInstanceProtocol::SEND_FILE_LEN,
              "info");
          write(connFd, fileLength.c_str(), fileLength.size());
          instance_logger.log("Sent : File length in bytes " + fileLength,
                              "info");
          ...
          if (line.compare(JasmineGraphInstanceProtocol::SEND_FILE_CONT) == 0) {
            instance_logger.log(
                "Received : " + JasmineGraphInstanceProtocol::SEND_FILE_CONT,
                "info");
            instance_logger.log("Going to send file through service", "info");
            JasmineGraphInstance::sendFileThroughService(
                serverHostName, stoi(serverHostDataPort), fileName, filePath);
          }
        }
      }
      int count = 0;
      while (true) {
        ...
        instance_logger.log(
            "Sent : " + JasmineGraphInstanceProtocol::FILE_RECV_CHK, "info");
        ...
        if (line.compare(JasmineGraphInstanceProtocol::FILE_RECV_WAIT) == 0) {
          instance_logger.log(
              "Received : " + JasmineGraphInstanceProtocol::FILE_RECV_WAIT,
              "info");
          instance_logger.log("Checking file status : " + to_string(count),
                              "info");
          count++;
          sleep(1);
          continue;
          ...
          instance_logger.log(
              "Received : " + JasmineGraphInstanceProtocol::FILE_ACK, "info");
      ...
      while (true) {
        ...
        instance_logger.log(
            "Sent : " + JasmineGraphInstanceProtocol::BATCH_UPLOAD_CHK, "info");
        bzero(data, INSTANCE_DATA_LENGTH + 1);
        read(connFd, data, INSTANCE_DATA_LENGTH);
        line = (data);

        if (line.compare(JasmineGraphInstanceProtocol::BATCH_UPLOAD_WAIT) ==
            0) {
          instance_logger.log(
              "Received : " + JasmineGraphInstanceProtocol::BATCH_UPLOAD_WAIT,
              "info");
          sleep(1);
          continue;
        } else if (line.compare(
                       JasmineGraphInstanceProtocol::BATCH_UPLOAD_ACK) == 0) {
          instance_logger.log(
              "Received : " + JasmineGraphInstanceProtocol::BATCH_UPLOAD_ACK,
              "info");
      ...
      loop = true;
                                ...
                                INITIATE_FRAGMENT_RESOLUTION) == 0) {
      instance_logger.log(
          "Received : " +
      ...
      while (true) {
        write(connFd,
              JasmineGraphInstanceProtocol::FRAGMENT_RESOLUTION_CHK.c_str(),
              JasmineGraphInstanceProtocol::FRAGMENT_RESOLUTION_CHK.size());
        instance_logger.log(
            "Sent : " + JasmineGraphInstanceProtocol::FRAGMENT_RESOLUTION_CHK,
            "info");
        ...
        if (listOfPartitions.compare(
                JasmineGraphInstanceProtocol::FRAGMENT_RESOLUTION_DONE) == 0) {
          break;
        } else {
          instance_logger.log("Received ===>: " + listOfPartitions, "info");
          ss << listOfPartitions;
      ...
      for (std::vector<string>::iterator x = partitions.begin();
           x != partitions.end(); ++x) {
      ...
      Utils utils;
      string dataFolder = utils.getJasmineGraphProperty(
          "org.jasminegraph.server.instance.datafolder");
      std::vector<string> listOfFiles =
          utils.getListOfFilesInDirectory(dataFolder);

      std::vector<std::string> graphIDsFromFileSystem;
      for (std::vector<string>::iterator x = listOfFiles.begin();
           x != listOfFiles.end(); ++x) {
        string graphID = x->substr(0, x->find_first_of("_"));
      ...
      for (std::vector<string>::iterator it = notInGraphIDList.begin();
           it != notInGraphIDList.end(); it++) {
        if (isdigit(it->c_str()[0])) {
          bool found = false;
          for (std::vector<int>::iterator it2 = notInItemsList.begin();
               it2 != notInItemsList.end(); it2++) {
      ...
      bool firstFlag = true;
      for (std::vector<int>::iterator it = notInItemsList.begin();
           it != notInItemsList.end(); it++) {
        int x = *it;
        if (firstFlag) {
      ...
      instance_logger.log("Sent : " + graphIDList, "info");
                   ...
                   JasmineGraphInstanceProtocol::CHECK_FILE_ACCESSIBLE) == 0) {
      instance_logger.log(
          "Received : " + JasmineGraphInstanceProtocol::CHECK_FILE_ACCESSIBLE,
          "info");
      write(connFd, JasmineGraphInstanceProtocol::SEND_FILE_TYPE.c_str(),
            JasmineGraphInstanceProtocol::SEND_FILE_TYPE.size());
      instance_logger.log(
          "Sent : " + JasmineGraphInstanceProtocol::SEND_FILE_TYPE, "info");
      bzero(data, INSTANCE_DATA_LENGTH + 1);
      read(connFd, data, INSTANCE_DATA_LENGTH);
      ...
      if (fileType.compare(
        ...
        write(connFd, result.c_str(), result.size());
        instance_logger.log("Sent : " + result, "info");
      } else if (fileType.compare(JasmineGraphInstanceProtocol::
                                      FILE_TYPE_CENTRALSTORE_COMPOSITE) == 0) {
        write(connFd, JasmineGraphInstanceProtocol::OK.c_str(),
              JasmineGraphInstanceProtocol::OK.size());
        instance_logger.log("Sent : " + JasmineGraphInstanceProtocol::OK,
                            "info");
    ...
    } else if (line.compare(JasmineGraphInstanceProtocol::GRAPH_STREAM_START) ==
               0) {
      write(connFd,
            JasmineGraphInstanceProtocol::GRAPH_STREAM_START_ACK.c_str(),
            JasmineGraphInstanceProtocol::GRAPH_STREAM_START_ACK.size());
      instance_logger.log(
          "Sent : " + JasmineGraphInstanceProtocol::GRAPH_STREAM_START_ACK,
          "info");
      ...
      if (return_status > 0) {
        ...
        instance_logger.log(
            "Received content_length = " + std::to_string(content_length),
            "info");
      } else {
      ...
      auto graphIdPartitionId =
          JasmineGraphIncrementalLocalStore::getIDs(nodeString);
      ...
      if (incrementalLocalStoreMap.find(graphIdentifier) ==
        ...
        incrementalLocalStoreInstance =
            JasmineGraphInstanceService::loadStreamingStore(
                graphId, partitionId, incrementalLocalStoreMap);
      } else {
        incrementalLocalStoreInstance =
            incrementalLocalStoreMap[graphIdentifier];
      }
      incrementalLocalStoreInstance->addEdgeFromString(nodeString);
      send(connFd,
           JasmineGraphInstanceProtocol::GRAPH_STREAM_END_OF_EDGE.c_str(),
      ...
      instance_logger.log(
          "Received : " + JasmineGraphInstanceProtocol::SEND_PRIORITY, "info");
      write(connFd, JasmineGraphInstanceProtocol::OK.c_str(),
            JasmineGraphInstanceProtocol::OK.size());
      instance_logger.log("Sent : " + JasmineGraphInstanceProtocol::OK, "info");
      bzero(data, INSTANCE_DATA_LENGTH + 1);
...
void JasmineGraphInstanceService::run(string profile, string masterHost,
  ...
  serviceArguments.graphDBMapDuplicateCentralStores =
      graphDBMapDuplicateCentralStores;
  ...
  instance_logger.log("Worker listening on port " + to_string(serverPort),
                      "info");
  while (connectionCounter < MAX_CONNECTION_COUNT) {
    ...
    if (connFd < 0) {
      instance_logger.log(
          "Cannot accept connection to port " + to_string(serverPort), "error");
    } else {
      instance_logger.log(
          "Connection successful to port " + to_string(serverPort), "info");
...
void deleteGraphPartition(std::string graphID, std::string partitionID) {
  ...
  instance_logger.log("Graph partition and centralstore files are now deleted",
                      "info");
}
...
void writeCatalogRecord(string record) {
  ...
  utils.createDirectory(utils.getJasmineGraphProperty(
      "org.jasminegraph.server.instance.datafolder"));
  string catalogFilePath = utils.getJasmineGraphProperty(
                               "org.jasminegraph.server.instance.datafolder") +
                           "/catalog.txt";
  ofstream outfile;
...
long countLocalTriangles(
  ...
  std::string graphIdentifier = graphId + "_" + partitionId;
  std::string centralGraphIdentifier =
      graphId + +"_centralstore_" + partitionId;
  std::string duplicateCentralGraphIdentifier =
      graphId + +"_centralstore_dp_" + partitionId;
  JasmineGraphHashMapLocalStore graphDB;
  JasmineGraphHashMapCentralStore centralGraphDB;
  JasmineGraphHashMapDuplicateCentralStore duplicateCentralGraphDB;

  std::map<std::string, JasmineGraphHashMapLocalStore>::iterator
      localMapIterator = graphDBMapLocalStores.find(graphIdentifier);
  std::map<std::string, JasmineGraphHashMapCentralStore>::iterator
      centralStoreIterator = graphDBMapCentralStores.find(graphIdentifier);
  std::map<std::string, JasmineGraphHashMapDuplicateCentralStore>::iterator
      duplicateCentralStoreIterator =
  ...
  if (duplicateCentralStoreIterator == graphDBMapDuplicateCentralStores.end()) {
    if (JasmineGraphInstanceService::isInstanceDuplicateCentralStoreExists(
            graphId, partitionId)) {
      JasmineGraphInstanceService::loadInstanceDuplicateCentralStore(
          graphId, partitionId, graphDBMapDuplicateCentralStores);
    }
    duplicateCentralGraphDB =
  ...
  result = Triangles::run(graphDB, centralGraphDB, duplicateCentralGraphDB,
                          graphId, partitionId, threadPriority);

  instance_logger.log(
      "###INSTANCE### Local Triangle Count : Completed: Triangles: " +
          to_string(result),
      "info");
...
bool JasmineGraphInstanceService::isGraphDBExists(std::string graphId,
                                                  std::string partitionId) {
  Utils utils;
  std::string dataFolder = utils.getJasmineGraphProperty(
      "org.jasminegraph.server.instance.datafolder");
...
bool JasmineGraphInstanceService::isInstanceCentralStoreExists(
    std::string graphId, std::string partitionId) {
  Utils utils;
  std::string dataFolder = utils.getJasmineGraphProperty(
      "org.jasminegraph.server.instance.datafolder");
  std::string filename =
      dataFolder + "/" + graphId + +"_centralstore_" + partitionId;
  std::ifstream dbFile(filename, std::ios::binary);
  if (!dbFile) {
    return false;
  }
...
bool JasmineGraphInstanceService::isInstanceDuplicateCentralStoreExists(
    std::string graphId, std::string partitionId) {
  Utils utils;
  std::string dataFolder = utils.getJasmineGraphProperty(
      "org.jasminegraph.server.instance.datafolder");
  std::string filename =
      dataFolder + "/" + graphId + +"_centralstore_dp_" + partitionId;
  std::ifstream dbFile(filename, std::ios::binary);
  if (!dbFile) {
    return false;
  }
...
JasmineGraphInstanceService::loadStreamingStore(
    std::string graphId, std::string partitionId,
    std::map<std::string, JasmineGraphIncrementalLocalStore *>
        &graphDBMapStreamingStores) {
  std::string graphIdentifier = graphId + "_" + partitionId;
  instance_logger.log("###INSTANCE### Loading streaming Store for" +
                          graphIdentifier + " : Started",
                      "info");
  Utils utils;
  std::string folderLocation = utils.getJasmineGraphProperty(
      "org.jasminegraph.server.instance.datafolder");
  JasmineGraphIncrementalLocalStore *jasmineGraphStreamingLocalStore =
      new JasmineGraphIncrementalLocalStore(atoi(graphId.c_str()),
                                            atoi(partitionId.c_str()));
  graphDBMapStreamingStores.insert(
      std::make_pair(graphIdentifier, jasmineGraphStreamingLocalStore));
...
void JasmineGraphInstanceService::loadLocalStore(
  ...
  JasmineGraphHashMapLocalStore *jasmineGraphHashMapLocalStore =
      new JasmineGraphHashMapLocalStore(
          atoi(graphId.c_str()), atoi(partitionId.c_str()), folderLocation);
  jasmineGraphHashMapLocalStore->loadGraph();
  graphDBMapLocalStores.insert(
      std::make_pair(graphIdentifier, *jasmineGraphHashMapLocalStore));
  instance_logger.log("###INSTANCE### Loading Local Store : Completed", "info");
}
void JasmineGraphInstanceService::loadInstanceCentralStore(
  ...
  JasmineGraphHashMapCentralStore *jasmineGraphHashMapCentralStore =
      new JasmineGraphHashMapCentralStore(atoi(graphId.c_str()),
                                          atoi(partitionId.c_str()));
  jasmineGraphHashMapCentralStore->loadGraph();
  graphDBMapCentralStores.insert(
      std::make_pair(graphIdentifier, *jasmineGraphHashMapCentralStore));
}
...
void JasmineGraphInstanceService::loadInstanceDuplicateCentralStore(
  ...
  JasmineGraphHashMapDuplicateCentralStore *jasmineGraphHashMapCentralStore =
      new JasmineGraphHashMapDuplicateCentralStore(atoi(graphId.c_str()),
                                                   atoi(partitionId.c_str()));
  jasmineGraphHashMapCentralStore->loadGraph();
  graphDBMapDuplicateCentralStores.insert(
      std::make_pair(graphIdentifier, *jasmineGraphHashMapCentralStore));
}

JasmineGraphHashMapCentralStore JasmineGraphInstanceService::loadCentralStore(
    std::string centralStoreFileName) {
  instance_logger.log("###INSTANCE### Loading Central Store File : Started " +
                          centralStoreFileName,
                      "info");
  JasmineGraphHashMapCentralStore *jasmineGraphHashMapCentralStore =
      new JasmineGraphHashMapCentralStore();
  jasmineGraphHashMapCentralStore->loadGraph(centralStoreFileName);
  instance_logger.log("###INSTANCE### Loading Central Store File : Completed",
                      "info");
  return *jasmineGraphHashMapCentralStore;
}

std::string JasmineGraphInstanceService::copyCentralStoreToAggregator(
    std::string graphId, std::string partitionId, std::string aggregatorHost,
  ...
  if (JasmineGraphInstanceService::isInstanceCentralStoreExists(graphId,
                                                                partitionId)) {
    ...
    if (aggregatorHost == host) {
      ...
      copyCommand = "scp " + centralStoreFile + " " + aggregatorHost + ":" +
                    aggregatorFilePath;
    }
...
string JasmineGraphInstanceService::aggregateCentralStoreTriangles(
    std::string graphId, std::string partitionId, std::string partitionIdList,
    int threadPriority) {
  Utils utils;
  instance_logger.log(
      "###INSTANCE### Started Aggregating Central Store Triangles", "info");
  std::string aggregatorFilePath = utils.getJasmineGraphProperty(
      "org.jasminegraph.server.instance.aggregatefolder");
  ...
  std::string dataFolder = utils.getJasmineGraphProperty(
      "org.jasminegraph.server.instance.datafolder");
  std::string workerCentralStoreFile =
      dataFolder + "/" + centralGraphIdentifier;
  instance_logger.log("###INSTANCE### Loading Central Store : Started " +
  ...
  instance_logger.log("###INSTANCE### Loading Central Store : Completed",
                      "info");
  map<long, unordered_set<long>> workerCentralGraphMap =
      workerCentralStore.getUnderlyingHashMap();

  map<long, unordered_set<long>>::iterator workerCentalGraphIterator;

  for (workerCentalGraphIterator = workerCentralGraphMap.begin();
       workerCentalGraphIterator != workerCentralGraphMap.end();
       ++workerCentalGraphIterator) {
  ...
  for (partitionIdListIterator = paritionIdList.begin();
       partitionIdListIterator != paritionIdList.end();
       ++partitionIdListIterator) {
    std::string aggregatePartitionId = *partitionIdListIterator;
    struct stat s;

    std::string centralGraphIdentifier =
        graphId + +"_centralstore_" + aggregatePartitionId;

    std::string centralStoreFile =
        aggregatorFilePath + "/" + centralGraphIdentifier;
    ...
    if (stat(centralStoreFile.c_str(), &s) == 0) {
      if (s.st_mode & S_IFREG) {
        ...
        map<long, unordered_set<long>> centralGraphMap =
            centralStore.getUnderlyingHashMap();
        map<long, unordered_set<long>>::iterator centralGraphMapIterator;

        for (centralGraphMapIterator = centralGraphMap.begin();
             centralGraphMapIterator != centralGraphMap.end();
          ...
          unordered_set<long> aggregatedEndVidSet =
  ...
  instance_logger.log("###INSTANCE### Central Store Aggregation : Completed",
                      "info");

  map<long, long> distributionHashMap =
      JasmineGraphInstanceService::getOutDegreeDistributionHashMap(
          aggregatedCentralStore);

  std::string triangles = Triangles::countCentralStoreTriangles(
      aggregatedCentralStore, distributionHashMap, threadPriority);

  return triangles;
}

string JasmineGraphInstanceService::aggregateCompositeCentralStoreTriangles(
    std::string compositeFileList, std::string availableFileList,
    int threadPriority) {
  Utils utils;
  instance_logger.log(
      "###INSTANCE### Started Aggregating Composite Central Store Triangles",
      "info");
  std::string aggregatorFilePath = utils.getJasmineGraphProperty(
      "org.jasminegraph.server.instance.aggregatefolder");
  std::string dataFolder = utils.getJasmineGraphProperty(
  ...
  std::vector<std::string> compositeCentralStoreFileList =
      Utils::split(compositeFileList, ':');
  std::vector<std::string>::iterator compositeCentralStoreFileIterator;
  std::vector<std::string> availableCompositeFileList =
      Utils::split(availableFileList, ':');
  ...
  for (availableCompositeFileIterator = availableCompositeFileList.begin();
       availableCompositeFileIterator != availableCompositeFileList.end();
       ++availableCompositeFileIterator) {
    ...
    if (stat(availableCompositeFile.c_str(), &st) == 0) {
      if (st.st_mode & S_IFREG) {
        JasmineGraphHashMapCentralStore centralStore =
            JasmineGraphInstanceService::loadCentralStore(
                availableCompositeFile);
        map<long, unordered_set<long>> compositeCentralGraphMap =
            centralStore.getUnderlyingHashMap();
        map<long, unordered_set<long>>::iterator
            compositeCentralGraphMapIterator;

        for (compositeCentralGraphMapIterator =
                 compositeCentralGraphMap.begin();
             compositeCentralGraphMapIterator != compositeCentralGraphMap.end();
             ++compositeCentralGraphMapIterator) {
          long startVid = compositeCentralGraphMapIterator->first;
          unordered_set<long> endVidSet =
              compositeCentralGraphMapIterator->second;

          unordered_set<long> aggregatedEndVidSet =
              aggregatedCompositeCentralStore[startVid];
          aggregatedEndVidSet.insert(endVidSet.begin(), endVidSet.end());
  ...
  for (compositeCentralStoreFileIterator =
           compositeCentralStoreFileList.begin();
       compositeCentralStoreFileIterator != compositeCentralStoreFileList.end();
       ++compositeCentralStoreFileIterator) {
    std::string compositeCentralStoreFileName =
        *compositeCentralStoreFileIterator;
    ...
    std::string compositeCentralStoreFile =
        aggregatorFilePath + "/" + rawFileName;
  ...
  std::string triangles = Triangles::countCentralStoreTriangles(
      aggregatedCompositeCentralStore, distributionHashMap, threadPriority);

  return triangles;
}

map<long, long> JasmineGraphInstanceService::getOutDegreeDistributionHashMap(
    map<long, unordered_set<long>> graphMap) {
  map<long, long> distributionHashMap;

  for (map<long, unordered_set<long>>::iterator it = graphMap.begin();
       it != graphMap.end(); ++it) {
...
string JasmineGraphInstanceService::requestPerformanceStatistics(
    std::string isVMStatManager, std::string isResourceAllocationRequested) {
  Utils utils;
  ...
  std::string vmLevelStatistics = collector.collectVMStatistics(
      isVMStatManager, isResourceAllocationRequested);
  ...
  std::string usageString = reportTimeString + "," + to_string(memoryUsage) +
                            "," + to_string(cpuUsage) + "," +
...
void JasmineGraphInstanceService::collectTrainedModels(
  ...
  int count = 0;
  std::map<std::string, JasmineGraphInstanceService::workerPartitions>::iterator
      mapIterator;
  for (mapIterator = graphPartitionedHosts.begin();
       mapIterator != graphPartitionedHosts.end(); mapIterator++) {
    string hostName = mapIterator->first;
    JasmineGraphInstanceService::workerPartitions workerPartitions =
        mapIterator->second;
    std::vector<std::string>::iterator it;
    for (it = workerPartitions.partitionID.begin();
         it != workerPartitions.partitionID.end(); it++) {
      workerThreads[count] = std::thread(
          &JasmineGraphInstanceService::collectTrainedModelThreadFunction,
...
int JasmineGraphInstanceService::collectTrainedModelThreadFunction(
    instanceservicesessionargs *sessionargs, std::string host, int port,
    int dataPort, std::string graphID, std::string partition) {
  Utils utils;
  bool result = true;
  std::cout << pthread_self() << " host : " << host << " port : " << port
            << " DPort : " << dataPort << std::endl;
  int sockfd;
  char data[INSTANCE_DATA_LENGTH + 1];
  bool loop = false;
  socklen_t len;
  ...
  instance_logger.log("Sent : " + JasmineGraphInstanceProtocol::HANDSHAKE,
                      "info");
  bzero(data, INSTANCE_DATA_LENGTH + 1);
  ...
  if (response.compare(JasmineGraphInstanceProtocol::HANDSHAKE_OK) == 0) {
    instance_logger.log(
        "Received : " + JasmineGraphInstanceProtocol::HANDSHAKE_OK, "info");
    ...
    write(sockfd,
          JasmineGraphInstanceProtocol::INITIATE_MODEL_COLLECTION.c_str(),
          JasmineGraphInstanceProtocol::INITIATE_MODEL_COLLECTION.size());
    instance_logger.log(
        "Sent : " + JasmineGraphInstanceProtocol::INITIATE_MODEL_COLLECTION,
        "info");
    ...
    if (response.compare(JasmineGraphInstanceProtocol::OK) == 0) {
      ...
      write(sockfd, to_string(server_port).c_str(),
            to_string(server_port).size());
      instance_logger.log("Sent : " + server_port, "info");

      int server_data_port = sessionargs->dataPort;
      write(sockfd, to_string(server_data_port).c_str(),
            to_string(server_data_port).size());
      ...
      while (utils.fileExists(fullFilePath) &&
        ...
        if (response.compare(JasmineGraphInstanceProtocol::FILE_RECV_CHK) ==
            0) {
    ...
    instance_logger.log(
        "There was an error in the model collection process and the response "
        "is :: " +
            response,
        "error");
  }
...
void JasmineGraphInstanceService::createPartitionFiles(std::string graphID,
                                                       std::string partitionID,
                                                       std::string fileType) {
  Utils utils;
  utils.createDirectory(utils.getJasmineGraphProperty(
  ...
  JasmineGraphHashMapLocalStore *hashMapLocalStore =
      new JasmineGraphHashMapLocalStore();
  string inputFilePath = utils.getJasmineGraphProperty(
                             "org.jasminegraph.server.instance.datafolder") +
                         "/" + graphID + "_" + partitionID;
  ...
  if (fileType == "centralstore") {
    inputFilePath = utils.getJasmineGraphProperty(
                        "org.jasminegraph.server.instance.datafolder") +
                    "/" + graphID + "_centralstore_" + partitionID;
    outputFilePath =
        utils.getJasmineGraphProperty(
  ...
  std::map<int, std::vector<int>> partEdgeMap =
      hashMapLocalStore->getEdgeHashMap(inputFilePath);
...
void JasmineGraphInstanceService::collectExecutionData(string iteration,
                                                       string trainArgs,
                                                       string partCount) {
  ...
  if (partitionCounter == stoi(partCount)) {
    ...
    JasmineGraphInstanceService::executeTrainingIterations(
        maxPartCountInVector);
    return;
  } else {
    return;
  }
...
void JasmineGraphInstanceService::executeTrainingIterations(int maxThreads) {
  ...
  for (auto bin = iterationData.begin(); bin != iterationData.end(); ++bin) {
    ...
    for (auto trainarg = partVector.begin(); trainarg != partVector.end();
         ++trainarg) {
    ...
    iterCounter++;
    instance_logger.log(
        "Trainings initiated for iteration " + to_string(iterCounter), "info");
    for (int threadCount = 0; threadCount < count; threadCount++) {
      threadList[threadCount].join();
    }
    instance_logger.log(
        "Trainings completed for iteration " + to_string(iterCounter), "info");
  }
  iterationData.clear();
  partitionCounter = 0;
}
...
void JasmineGraphInstanceService::trainPartition(string trainData) {
  ...
  std::vector<char *> vc;
  std::transform(trainargs.begin(), trainargs.end(), std::back_inserter(vc),
                 converter);
...
map<long, long>
JasmineGraphInstanceService::calculateLocalOutDegreeDistribution(
  ...
  map<long, long> degreeDistributionCentral =
      centralDB.getInDegreeDistributionHashMap();
  std::map<long, long>::iterator itcentral;

  for (its = degreeDistributionCentral.begin();
       its != degreeDistributionCentral.end(); ++its) {
    bool centralNodeFound = false;
    for (itcentral = degreeDistribution.begin();
         itcentral != degreeDistribution.end(); ++itcentral) {
...
bool JasmineGraphInstanceService::duplicateCentralStore(
    int thisWorkerPort, int graphID, int partitionID,
    std::vector<string> workerSockets, std::string masterIP) {
  Utils utils;
  std::string aggregatorFilePath = utils.getJasmineGraphProperty(
      "org.jasminegraph.server.instance.aggregatefolder");
  std::string dataFilePath = utils.getJasmineGraphProperty(
      "org.jasminegraph.server.instance.datafolder");

  std::string centralGraphIdentifierUnCompressed =
      to_string(graphID) + "_centralstore_" + to_string(partitionID);
  std::string centralStoreFileUnCompressed =
      dataFilePath + "/" + centralGraphIdentifierUnCompressed;
  std::string centralStoreFileUnCompressedDestination =
      aggregatorFilePath + "/" + centralGraphIdentifierUnCompressed;

  // temporary copy the central store into the aggregate folder in order to
  // compress and send
  ...
  std::string centralGraphIdentifier =
      to_string(graphID) + "_centralstore_" + to_string(partitionID) + ".gz";
  std::string centralStoreFile =
      aggregatorFilePath + "/" + centralGraphIdentifier;
  instance_logger.log("###INSTANCE### centralstore " + centralStoreFile,
                      "info");
  ...
  for (vector<string>::iterator workerIt = workerSockets.begin();
    ...
    if (workerSocketPair.size() != 4) {
      instance_logger.log("Received worker socket information is invalid ",
                          "error");
      return 0;
    }
    ...
    if (stat(centralStoreFile.c_str(), &fileStat) == 0) {
      if (fileStat.st_mode & S_IFREG) {
        ...
        if (response.compare(JasmineGraphInstanceProtocol::HANDSHAKE_OK) == 0) {
          instance_logger.log(
              "Received : " + JasmineGraphInstanceProtocol::HANDSHAKE_OK,
              "info");
          ...
          if (response.compare(JasmineGraphInstanceProtocol::HOST_OK) == 0) {
            instance_logger.log(
                "Received : " + JasmineGraphInstanceProtocol::HOST_OK, "info");
          } else {
          ...
          result_wr =
              write(sockfd,
                    JasmineGraphInstanceProtocol::BATCH_UPLOAD_CENTRAL.c_str(),
          ...
          instance_logger.log(
              "Sent : " + JasmineGraphInstanceProtocol::BATCH_UPLOAD_CENTRAL,
              "info");
          bzero(data, INSTANCE_DATA_LENGTH + 1);
          read(sockfd, data, INSTANCE_DATA_LENGTH);
          response = (data);
          ...
          if (response.compare(JasmineGraphInstanceProtocol::OK) == 0) {
            ...
            result_wr = write(sockfd, std::to_string(graphID).c_str(),
                              std::to_string(graphID).size());
            if (result_wr < 0) {
              instance_logger.log("Error writing to socket", "error");
            }

            instance_logger.log("Sent : Graph ID " + std::to_string(graphID),
                                "info");
            ...
            if (response.compare(
                    JasmineGraphInstanceProtocol::SEND_FILE_NAME) == 0) {
              instance_logger.log(
                  "Received : " + JasmineGraphInstanceProtocol::SEND_FILE_NAME,
                  "info");
              ...
              if (response.compare(
                      JasmineGraphInstanceProtocol::SEND_FILE_LEN) == 0) {
                instance_logger.log(
                    "Received : " + JasmineGraphInstanceProtocol::SEND_FILE_LEN,
                    "info");
                result_wr =
                ...
                response = (data);
                if (response.compare(
                        JasmineGraphInstanceProtocol::SEND_FILE_CONT) == 0) {
                  instance_logger.log(
                      "Received : " +
                          JasmineGraphInstanceProtocol::SEND_FILE_CONT,
                      "info");
                  instance_logger.log("Going to send file through service",
                                      "info");
                  JasmineGraphInstanceService::sendFileThroughService(
                      host, dataPort, fileName, centralStoreFile, masterIP);
                }
              }
            }
            int count = 0;
            ...
            while (true) {
              result_wr = write(
                  sockfd, JasmineGraphInstanceProtocol::FILE_RECV_CHK.c_str(),
                  JasmineGraphInstanceProtocol::FILE_RECV_CHK.size());
              ...
              instance_logger.log(
                  "Sent : " + JasmineGraphInstanceProtocol::FILE_RECV_CHK,
                  "info");
              instance_logger.log("Checking if file is received", "info");
              bzero(data, INSTANCE_DATA_LENGTH + 1);
              read(sockfd, data, INSTANCE_DATA_LENGTH);
              response = (data);
              if (response.compare(
                      JasmineGraphInstanceProtocol::FILE_RECV_WAIT) == 0) {
                instance_logger.log(
                    "Received : " +
                        JasmineGraphInstanceProtocol::FILE_RECV_WAIT,
                    "info");
                instance_logger.log(
                    "Checking file status : " + to_string(count), "info");
                count++;
                sleep(1);
                continue;
              } else if (response.compare(
                             JasmineGraphInstanceProtocol::FILE_ACK) == 0) {
                instance_logger.log(
                    "Received : " + JasmineGraphInstanceProtocol::FILE_ACK,
                    "info");
                instance_logger.log(
                    "File transfer completed for file : " + centralStoreFile,
                    "info");
                break;
              }
            };
            ...
            while (true) {
              result_wr =
                  write(sockfd,
                        JasmineGraphInstanceProtocol::BATCH_UPLOAD_CHK.c_str(),
                        JasmineGraphInstanceProtocol::BATCH_UPLOAD_CHK.size());
              ...
              instance_logger.log(
                  "Sent : " + JasmineGraphInstanceProtocol::BATCH_UPLOAD_CHK,
                  "info");
              bzero(data, INSTANCE_DATA_LENGTH + 1);
              read(sockfd, data, INSTANCE_DATA_LENGTH);
              response = (data);
              ...
              if (response.compare(
                      JasmineGraphInstanceProtocol::BATCH_UPLOAD_WAIT) == 0) {
                instance_logger.log(
                    "Received : " +
                        JasmineGraphInstanceProtocol::BATCH_UPLOAD_WAIT,
                    "info");
                sleep(1);
                continue;
              } else if (response.compare(
                             JasmineGraphInstanceProtocol::BATCH_UPLOAD_ACK) ==
                         0) {
                instance_logger.log(
                    "Received : " +
                        JasmineGraphInstanceProtocol::BATCH_UPLOAD_ACK,
          ...
          instance_logger.log(
              "There was an error in the upload process and the response is "
              ":: " +
                  response,
              "error");
        }
...
bool JasmineGraphInstanceService::sendFileThroughService(std::string host,
                                                         int dataPort,
                                                         std::string fileName,
                                                         std::string filePath,
                                                         std::string masterIP) {
  ...
  if (response.compare(JasmineGraphInstanceProtocol::SEND_FILE) == 0) {
    std::cout << "Sending file " << filePath << " through port " << dataPort
              << std::endl;
...
map<long, long> calculateLocalOutDegreeDist(
  ...
  map<long, long> degreeDistributionLocal =
      graphDB.getOutDegreeDistributionHashMap();
  std::map<long, long>::iterator itlocal;

  map<long, long> degreeDistributionCentral =
      centralDB.getOutDegreeDistributionHashMap();
  std::map<long, long>::iterator itcentral;

  map<long, long> degreeDistributionCentralTotal;

  map<long, unordered_set<long>> centralGraphMap =
      centralDB.getUnderlyingHashMap();
  ...
  for (itcentral = degreeDistributionCentral.begin();
       itcentral != degreeDistributionCentral.end(); ++itcentral) {
    bool centralNodeFound = false;
    for (itlocal = degreeDistributionLocal.begin();
         itlocal != degreeDistributionLocal.end(); ++itlocal) {
      if ((itcentral->first) == (itlocal->first)) {
        degreeDistributionCentralTotal.insert(std::make_pair(
            itcentral->first, (itlocal->second + itcentral->second)));
        centralNodeFound = true;
        break;
      }
    }
    if (!centralNodeFound) {
      degreeDistributionCentralTotal.insert(
          std::make_pair(itcentral->first, itcentral->second));
    }
  }
...
map<long, long> calculateInDegreeDist(
  ...
  instance_logger.log(
      "In Degree Dist size: " + to_string(degreeDistribution.size()), "info");
  ...
  for (vector<string>::iterator workerIt = workerSockets.begin();
    ...
    int result_wr = write(
        sockfd,
        JasmineGraphInstanceProtocol::WORKER_IN_DEGREE_DISTRIBUTION.c_str(),
    ...
    instance_logger.log(
        "Sent : " + JasmineGraphInstanceProtocol::WORKER_IN_DEGREE_DISTRIBUTION,
        "info");
...
map<long, map<long, unordered_set<long>>> calculateLocalEgoNet(
    string graphID, string partitionID, int serverPort,
  ...
  for (map<long, unordered_set<long>>::iterator it = localGraphMap.begin();
       it != localGraphMap.end(); ++it) {
    ...
    for (unordered_set<long>::iterator neighbour = neighbours.begin();
         neighbour != neighbours.end(); ++neighbour) {
      unordered_set<long> neighboursOfNeighboursInSameEgoNet;

      map<long, unordered_set<long>>::iterator localGraphMapItr =
          localGraphMap.find(*neighbour);
      if (localGraphMapItr != localGraphMap.end()) {
        ...
        for (auto neighboursOfNeighbourItr = neighboursOfNeighbour.begin();
             neighboursOfNeighbourItr != neighboursOfNeighbour.end();
             ++neighboursOfNeighbourItr) {
          unordered_set<long>::iterator neighboursItr =
              neighbours.find(*neighboursOfNeighbourItr);
          if (neighboursItr != neighbours.end()) {
            neighboursOfNeighboursInSameEgoNet.insert(*neighboursItr);
          }
        }
      }
      individualEgoNet.insert(
          std::make_pair(*neighbour, neighboursOfNeighboursInSameEgoNet));
    }

    egonetMap.insert(std::make_pair(it->first, individualEgoNet));
  }

  for (map<long, unordered_set<long>>::iterator it = centralGraphMap.begin();
       it != centralGraphMap.end(); ++it) {
    unordered_set<long> distribution = it->second;

    map<long, map<long, unordered_set<long>>>::iterator egonetMapItr =
        egonetMap.find(it->first);
    ...
    if (egonetMapItr == egonetMap.end()) {
      ...
      vertexMapFromCentralStore.insert(
          std::make_pair(it->first,
                         distribution));  // Here we do not have the relation
      ...
      map<long, unordered_set<long>>::iterator egonetSubGraphItr =
          egonetSubGraph.find(it->first);
      if (egonetSubGraphItr != egonetSubGraph.end()) {
        unordered_set<long> egonetSubGraphNeighbours =
            egonetSubGraphItr->second;
        egonetSubGraphNeighbours.insert(distribution.begin(),
                                        distribution.end());
  ...
  for (vector<string>::iterator workerIt = workerSockets.begin();
    ...
    std::string aggregatorFilePath = utils.getJasmineGraphProperty(
        "org.jasminegraph.server.instance.datafolder");
    std::string centralGraphIdentifier =
        graphID + +"_centralstore_" + workerSocketPair[2];
    ...
    if (stat(centralStoreFile.c_str(), &centralStoreFileBuffer) == 0) {
      if (centralStoreFileBuffer.st_mode & S_IFREG) {
        ...
        for (map<long, unordered_set<long>>::iterator centralGraphMapIterator =
                 centralGraphMap.begin();
             centralGraphMapIterator != centralGraphMap.end();
             ++centralGraphMapIterator) {
          long startVid = centralGraphMapIterator->first;
          unordered_set<long> endVidSet = centralGraphMapIterator->second;
          ...
          for (auto itr = endVidSet.begin(); itr != endVidSet.end(); ++itr) {
            ...
            if (egonetMapItr != egonetMap.end()) {
              map<long, unordered_set<long>> egonetSubGraph =
                  egonetMapItr->second;
              map<long, unordered_set<long>>::iterator egonetSubGraphItr =
                  egonetSubGraph.find(*itr);
              if (egonetSubGraphItr != egonetSubGraph.end()) {
                unordered_set<long> egonetSubGraphNeighbours =
                    egonetSubGraphItr->second;
...
void calculateEgoNet(string graphID, string partitionID, int serverPort,
                     JasmineGraphHashMapLocalStore localDB,
                     JasmineGraphHashMapCentralStore centralDB,
                     string workerList) {
  std::vector<string> workerSockets;
  ...
  map<long, map<long, unordered_set<long>>> egonetMap = calculateLocalEgoNet(
      graphID, partitionID, serverPort, localDB, centralDB, workerSockets);
  ...
  for (vector<string>::iterator workerIt = workerSockets.begin();
    ...
    bzero(data, 301);
    int result_wr =
        write(sockfd, JasmineGraphInstanceProtocol::WORKER_EGO_NET.c_str(),
    ...
    instance_logger.log(
        "Sent : " + JasmineGraphInstanceProtocol::WORKER_EGO_NET, "info");
...
map<long, double> calculateLocalPageRank(
    string graphID, double alpha, string partitionID, int serverPort,
  ...
  map<long, long> localOutDegreeDistMap =
      localDB.getOutDegreeDistributionHashMap();

  long partitionVertexCount = localGraphMap.size();
  long worldOnlyVertexCount =
      atol(graphVertexCount.c_str()) - partitionVertexCount;
  ...
  map<long, float> hMapAuthorityFlowWorldToLocal =
      getAuthorityScoresWorldToLocal(
          graphID, partitionID, serverPort, graphVertexCount, localDB,
          centralDB, localGraphMap, workerSockets, worldOnlyVertexCount);

  map<long, unordered_set<long>> hMapFromVerticesWorldToLocalFLow =
      getEdgesWorldToLocal(graphID, partitionID, serverPort, graphVertexCount,
                           localDB, centralDB, localGraphMap, workerSockets);
  ...
  for (auto &hMapAuthorityFlowWorldToLocalIterator :
       hMapAuthorityFlowWorldToLocal) {
  ...
  while (count < iterations) {
    for (localGraphMapIterator = localGraphMap.begin();
         localGraphMapIterator != localGraphMap.end();
  ...
  if (top_k_page_rank_value == -1) {
    ...
    for (map<long, double>::iterator rankMapItr = rankMap.begin();
         rankMapItr != rankMap.end(); ++rankMapItr) {
      rankMapResults.insert(
          std::make_pair(rankMapItr->second, rankMapItr->first));
    }
...
map<long, float> getAuthorityScoresWorldToLocal(
    string graphID, string partitionID, int serverPort, string graphVertexCount,
    JasmineGraphHashMapLocalStore localDB,
    JasmineGraphHashMapCentralStore centralDB,
    ...
    if (stat(centralStoreFile.c_str(), &s) == 0) {
      if (s.st_mode & S_IFREG) {
        ...
        for (map<long, unordered_set<long>>::iterator centralGraphMapIterator =
          ...
          for (auto itr = endVidSet.begin(); itr != endVidSet.end(); ++itr) {
            map<long, long>::iterator fromDegreeDistIterator =
                fromDegreeDist.find(startVid);
            ...
            if (graphVertexMap.find(*itr) != graphVertexMap.end()) {
              map<long, unordered_set<long>>::iterator toIDiterator =
                  worldToLocalVertexMap.find(*itr);
  ...
  for (map<long, unordered_set<long>>::iterator it =
           worldToLocalVertexMap.begin();
    ...
    for (auto itr = distribution.begin(); itr != distribution.end(); ++itr) {
      ...
      if (oddIterator != fromDegreeDist.end()) {
        ...
        map<long, float>::iterator authResultMapItr =
            authResultMap.find(it->first);
        if (authResultMapItr != authResultMap.end()) {
          authorityScore = authResultMapItr->second;
          authResultMapItr->second =
              authorityScore + (alpha * (1.0 / degree) + mu);
        } else {
          authResultMap.insert(
              std::make_pair(it->first, (alpha * (1.0 / degree) + mu)));
        }
      }
    }
  }
  ...
  for (map<long, float>::iterator it = authResultMap.begin();
       it != authResultMap.end(); ++it) {
...
map<long, unordered_set<long>> getEdgesWorldToLocal(
    string graphID, string partitionID, int serverPort, string graphVertexCount,
    JasmineGraphHashMapLocalStore localDB,
    JasmineGraphHashMapCentralStore centralDB,
    map<long, unordered_set<long>> graphVertexMap,
...
void JasmineGraphInstanceService::initServer(string trainData) {
  ...
  std::string path =
      "cd " + utils.getJasmineGraphProperty("org.jasminegraph.fl.location") +
      " && ";
  std::string command =
      path + "python3 fl_server.py " +
      utils.getJasmineGraphProperty("org.jasminegraph.fl.weights") + " " +
      ...
      " localhost 5000 > server_logs.txt";
...
void JasmineGraphInstanceService::initOrgServer(string trainData) {
  ...
  std::string path =
      ...
      " && ";
  std::string command =
      path + "python3 org_server.py " + graphID + " " +
      utils.getJasmineGraphProperty("org.jasminegraph.fl_clients") + " " +
      utils.getJasmineGraphProperty("org.jasminegraph.fl.epochs") +
...
void JasmineGraphInstanceService::initAgg(string trainData) {
  ...
  std::string path =
      ...
      " && ";
  std::string command =
      path + "python3 org_agg.py " + " " +
      utils.getJasmineGraphProperty("org.jasminegraph.fl.dataDir") + " " +
      utils.getJasmineGraphProperty("org.jasminegraph.fl.dataDir") + " " + "4" +
      " 0 " + utils.getJasmineGraphProperty("org.jasminegraph.fl.num.orgs") +
      " " + utils.getJasmineGraphProperty("org.jasminegraph.fl.epochs") +
      " localhost 5000 > agg_logs.txt";
  popen(command.c_str(), "r");
}
...
void JasmineGraphInstanceService::initClient(string trainData) {
  ...
  std::string command =
      ...
      utils.getJasmineGraphProperty("org.jasminegraph.fl.epochs") +
      " localhost " +
      utils.getJasmineGraphProperty("org.jasminegraph.fl.org.port") +
...
void JasmineGraphInstanceService::mergeFiles(string trainData) {
  ...
  std::string command =
      ...
      utils.getJasmineGraphProperty(
          "org.jasminegraph.server.instance.trainedmodelfolder") +
      " " + utils.getJasmineGraphProperty("org.jasminegraph.fl.dataDir") + " " +
      graphID + " " + partitionID + " > merge_logs" + partitionID + ".txt";
