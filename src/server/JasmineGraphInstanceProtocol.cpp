...
const string JasmineGraphInstanceProtocol::BATCH_UPLOAD_COMPOSITE_CENTRAL =
    "upload-g-c-c";
...
const string JasmineGraphInstanceProtocol::UPLOAD_RDF_ATTRIBUTES =
    "upload-attrib";
const string JasmineGraphInstanceProtocol::UPLOAD_RDF_ATTRIBUTES_CENTRAL =
    "upload-attrib-c";
...
const string JasmineGraphInstanceProtocol::SEND_PARTITION_ITERATION =
    "part-iter";
...
const string JasmineGraphInstanceProtocol::WORKER_OUT_DEGREE_DISTRIBUTION =
    "odd-worker";
const string JasmineGraphInstanceProtocol::IN_DEGREE_DISTRIBUTION = "idd";
const string JasmineGraphInstanceProtocol::WORKER_IN_DEGREE_DISTRIBUTION =
    "idd-worker";
const string JasmineGraphInstanceProtocol::WORKER_PAGE_RANK_DISTRIBUTION =
    "pgrn-worker";
...
const string JasmineGraphInstanceProtocol::SEND_CENTRALSTORE_TO_AGGREGATOR =
    "aggre-copy";
const string
    JasmineGraphInstanceProtocol::SEND_COMPOSITE_CENTRALSTORE_TO_AGGREGATOR =
        "composite-aggre-copy";
const string JasmineGraphInstanceProtocol::AGGREGATE_CENTRALSTORE_TRIANGLES =
    "aggregate";
const string
...
const string JasmineGraphInstanceProtocol::REQUEST_COLLECTED_STATS =
    "request-stat";
...
const string JasmineGraphInstanceProtocol::INITIATE_MODEL_COLLECTION =
    "initiate-model-collection";
const string JasmineGraphInstanceProtocol::INITIATE_FRAGMENT_RESOLUTION =
    "frag-res";
const string JasmineGraphInstanceProtocol::FRAGMENT_RESOLUTION_CHK = "frag-chk";
const string JasmineGraphInstanceProtocol::FRAGMENT_RESOLUTION_DONE =
    "frag-done";
...
const string JasmineGraphInstanceProtocol::CHECK_FILE_ACCESSIBLE =
    "check-file-accessible";
const string JasmineGraphInstanceProtocol::SEND_FILE_TYPE = "send-file-type";
const string JasmineGraphInstanceProtocol::FILE_TYPE_CENTRALSTORE_AGGREGATE =
    "file-type-centralstore-aggregate";
const string JasmineGraphInstanceProtocol::FILE_TYPE_CENTRALSTORE_COMPOSITE =
    "file-type-centralstore-composite";
const string JasmineGraphInstanceProtocol::GRAPH_STREAM_START = "stream-start";
const string JasmineGraphInstanceProtocol::GRAPH_STREAM_START_ACK =
    "stream-start-ack";
const string JasmineGraphInstanceProtocol::SEND_PRIORITY = "send-priority";
const string JasmineGraphInstanceProtocol::GRAPH_STREAM_C_length_ACK =
    "stream-c-length-ack";
...
const string JasmineGraphInstanceProtocol::INITIATE_ORG_SERVER =
    "initiate-org-server";
