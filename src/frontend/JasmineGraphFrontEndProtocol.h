...
class JasminGraphFrontEndProtocol {
  // Note that this protocol do not need a handshake session since the
  // communication in most of the time is conducted between JasminGraph and
  // Humans. The commands ending with -send are asking the graph id to be sent.
  // The precommand.
};
