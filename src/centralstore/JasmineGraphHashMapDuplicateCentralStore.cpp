...
bool JasmineGraphHashMapDuplicateCentralStore::loadGraph() {
  ...
  std::string edgeStorePath = instanceDataFolderLocation + getFileSeparator() +
                              std::to_string(graphId) + "_centralstore_dp_" +
...
bool JasmineGraphHashMapDuplicateCentralStore::storeGraph() {
  ...
  for (localSubGraphMapIterator = centralDuplicateStoreSubgraphMap.begin();
       localSubGraphMapIterator != centralDuplicateStoreSubgraphMap.end();
...
JasmineGraphHashMapDuplicateCentralStore::getUnderlyingHashMap() {
  return centralDuplicateStoreSubgraphMap;
}

map<long, long>
JasmineGraphHashMapDuplicateCentralStore::getOutDegreeDistributionHashMap() {
  map<long, long> distributionHashMap;

  for (map<long, unordered_set<long>>::iterator it =
           centralDuplicateStoreSubgraphMap.begin();
...
void JasmineGraphHashMapDuplicateCentralStore::addEdge(long startVid,
                                                       long endVid) {
  map<long, unordered_set<long>>::iterator entryIterator =
      centralDuplicateStoreSubgraphMap.find(startVid);
...
void JasmineGraphHashMapDuplicateCentralStore::toLocalSubGraphMap(
...
bool JasmineGraphHashMapDuplicateCentralStore::storePartEdgeMap(
