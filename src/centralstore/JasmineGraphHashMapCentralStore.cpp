...
JasmineGraphHashMapCentralStore::JasmineGraphHashMapCentralStore(
  ...
  instanceDataFolderLocation = utils.getJasmineGraphProperty(
      "org.jasminegraph.server.instance.datafolder");
}

bool JasmineGraphHashMapCentralStore::loadGraph() {
  bool result = false;
  std::string edgeStorePath = instanceDataFolderLocation + getFileSeparator() +
                              std::to_string(graphId) + "_centralstore_" +
...
bool JasmineGraphHashMapCentralStore::storeGraph() {
  ...
  for (localSubGraphMapIterator = centralSubgraphMap.begin();
       localSubGraphMapIterator != centralSubgraphMap.end();
...
JasmineGraphHashMapCentralStore::getUnderlyingHashMap() {
  return centralSubgraphMap;
}

map<long, long>
JasmineGraphHashMapCentralStore::getOutDegreeDistributionHashMap() {
  map<long, long> distributionHashMap;

  for (map<long, unordered_set<long>>::iterator it = centralSubgraphMap.begin();
       it != centralSubgraphMap.end(); ++it) {
...
map<long, long>
JasmineGraphHashMapCentralStore::getInDegreeDistributionHashMap() {
  map<long, long> distributionHashMap;
...
void JasmineGraphHashMapCentralStore::addEdge(long startVid, long endVid) {
  map<long, unordered_set<long>>::iterator entryIterator =
      centralSubgraphMap.find(startVid);
...
void JasmineGraphHashMapCentralStore::toLocalSubGraphMap(
...
bool JasmineGraphHashMapCentralStore::storePartEdgeMap(
