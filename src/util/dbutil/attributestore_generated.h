...
struct AttributeStore FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<AttributeStoreEntry>> *entries()
      const {
    return GetPointer<
        const flatbuffers::Vector<flatbuffers::Offset<AttributeStoreEntry>> *>(
        VT_ENTRIES);
  }
...
struct AttributeStoreBuilder {
  ...
  void add_entries(
      flatbuffers::Offset<
          flatbuffers::Vector<flatbuffers::Offset<AttributeStoreEntry>>>
          entries) {
...
inline flatbuffers::Offset<AttributeStore> CreateAttributeStoreDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<flatbuffers::Offset<AttributeStoreEntry>> *entries =
        nullptr) {
  auto entries__ =
      entries ? _fbb.CreateVector<flatbuffers::Offset<AttributeStoreEntry>>(
                    *entries)
              : 0;
  return JasmineGraph::AttributeStore::CreateAttributeStore(_fbb, entries__);
}

struct AttributeStoreEntry FLATBUFFERS_FINAL_CLASS
...
inline flatbuffers::Offset<AttributeStoreEntry> CreateAttributeStoreEntryDirect(
  ...
  auto value__ =
      value
          ...
          : 0;
  return JasmineGraph::AttributeStore::CreateAttributeStoreEntry(_fbb, key,
                                                                 value__);
}

inline const JasmineGraph::AttributeStore::AttributeStore *GetAttributeStore(
    const void *buf) {
  return flatbuffers::GetRoot<JasmineGraph::AttributeStore::AttributeStore>(
      buf);
}

inline const JasmineGraph::AttributeStore::AttributeStore *
GetSizePrefixedAttributeStore(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<
      JasmineGraph::AttributeStore::AttributeStore>(buf);
}

inline bool VerifyAttributeStoreBuffer(flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<JasmineGraph::AttributeStore::AttributeStore>(
      nullptr);
}
...
inline bool VerifySizePrefixedAttributeStoreBuffer(
  ...
  return verifier
      .VerifySizePrefixedBuffer<JasmineGraph::AttributeStore::AttributeStore>(
          nullptr);
}
