...
struct PartEdgeMapStore FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<PartEdgeMapStoreEntry>>
      *entries() const {
    return GetPointer<const flatbuffers::Vector<
        flatbuffers::Offset<PartEdgeMapStoreEntry>> *>(VT_ENTRIES);
  }
...
struct PartEdgeMapStoreBuilder {
  ...
  void add_entries(
      flatbuffers::Offset<
          flatbuffers::Vector<flatbuffers::Offset<PartEdgeMapStoreEntry>>>
          entries) {
...
inline flatbuffers::Offset<PartEdgeMapStore> CreatePartEdgeMapStoreDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<flatbuffers::Offset<PartEdgeMapStoreEntry>> *entries =
        nullptr) {
  auto entries__ =
      entries ? _fbb.CreateVector<flatbuffers::Offset<PartEdgeMapStoreEntry>>(
                    *entries)
              : 0;
  return JasmineGraph::PartEdgeMapStore::CreatePartEdgeMapStore(_fbb,
                                                                entries__);
}

struct PartEdgeMapStoreEntry FLATBUFFERS_FINAL_CLASS
...
inline flatbuffers::Offset<PartEdgeMapStoreEntry>
CreatePartEdgeMapStoreEntryDirect(flatbuffers::FlatBufferBuilder &_fbb,
                                  int32_t key = 0,
                                  const std::vector<int32_t> *value = nullptr) {
  auto value__ = value ? _fbb.CreateVector<int32_t>(*value) : 0;
  return JasmineGraph::PartEdgeMapStore::CreatePartEdgeMapStoreEntry(_fbb, key,
                                                                     value__);
}

inline const JasmineGraph::PartEdgeMapStore::PartEdgeMapStore *
GetPartEdgeMapStore(const void *buf) {
  return flatbuffers::GetRoot<JasmineGraph::PartEdgeMapStore::PartEdgeMapStore>(
      buf);
}

inline const JasmineGraph::PartEdgeMapStore::PartEdgeMapStore *
GetSizePrefixedPartEdgeMapStore(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<
      JasmineGraph::PartEdgeMapStore::PartEdgeMapStore>(buf);
}

inline bool VerifyPartEdgeMapStoreBuffer(flatbuffers::Verifier &verifier) {
  return verifier
      .VerifyBuffer<JasmineGraph::PartEdgeMapStore::PartEdgeMapStore>(nullptr);
}

inline bool VerifySizePrefixedPartEdgeMapStoreBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<
      JasmineGraph::PartEdgeMapStore::PartEdgeMapStore>(nullptr);
}

inline void FinishPartEdgeMapStoreBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<JasmineGraph::PartEdgeMapStore::PartEdgeMapStore>
        root) {
  fbb.Finish(root);
}
