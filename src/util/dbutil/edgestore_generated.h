...
struct EdgeStore FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<EdgeStoreEntry>> *entries()
      const {
    return GetPointer<
        const flatbuffers::Vector<flatbuffers::Offset<EdgeStoreEntry>> *>(
        VT_ENTRIES);
  }
...
struct EdgeStoreBuilder {
  ...
  void add_entries(flatbuffers::Offset<
                   flatbuffers::Vector<flatbuffers::Offset<EdgeStoreEntry>>>
                       entries) {
    fbb_.AddOffset(EdgeStore::VT_ENTRIES, entries);
  }

  explicit EdgeStoreBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
...
inline flatbuffers::Offset<EdgeStore> CreateEdgeStoreDirect(
  ...
  return JasmineGraph::Edgestore::CreateEdgeStore(
      _fbb,
      entries ? _fbb.CreateVector<flatbuffers::Offset<EdgeStoreEntry>>(*entries)
              : 0);
}
...
inline flatbuffers::Offset<EdgeStoreEntry> CreateEdgeStoreEntryDirect(
  ...
  return JasmineGraph::Edgestore::CreateEdgeStoreEntry(
      _fbb, key, value ? _fbb.CreateVector<int64_t>(*value) : 0);
}
...
inline const JasmineGraph::Edgestore::EdgeStore *GetSizePrefixedEdgeStore(
    const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<JasmineGraph::Edgestore::EdgeStore>(
      buf);
}
...
inline bool VerifySizePrefixedEdgeStoreBuffer(flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<JasmineGraph::Edgestore::EdgeStore>(
      nullptr);
}
