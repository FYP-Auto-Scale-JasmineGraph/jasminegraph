...
class Utils {
 public:
  ...
  bool hostExists(std::string name, std::string ip, std::string workerPort,
  ...
  static void assignPartitionsToWorkers(int numberOfWorkers,
                                        SQLiteDBInterface sqlite);

  static void updateSLAInformation(PerformanceSQLiteDBInterface perfSqlite,
